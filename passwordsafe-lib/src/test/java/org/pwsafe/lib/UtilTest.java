...
public class UtilTest extends TestCase {
	...
	public final void testBytesAreEqual() {
		assertTrue(Util.bytesAreEqual(new byte[] { 1, -2, 3, -4, 5 },
				new byte[] { 1, -2, 3, -4, 5 }));

		assertTrue(!Util.bytesAreEqual(new byte[] { 1, -2, 3, -4, 5, 6 }, new byte[] { 1, -2, 3,
				-4, 5 }));

		assertTrue(!Util.bytesAreEqual(new byte[] { 1, -2, 3, -4, 6 },
				new byte[] { 1, -2, 3, -4, 5 }));
	}
	...
	public final void testByteToHex2() {
		final byte b[] = new byte[] { -92, 0, -1, 1, 127, -128 };

		assertEquals(Util.bytesToHex(b), "a400ff017f80");
	}

	/**
	 * Unit test for {@link Util#bytesToHex(byte[], int, int)} for a byte array
	...
	/**
	 * Unit test for {@link Util#bytesToHex(byte[], int, int)} array index goes
	 * out of bounds.
	 */
	...
	public final void testCloneByteArray1() {
		final byte b[] = new byte[] { 1, 2, 3, 4, 5, 6, -1 };
		final byte c[] = Util.cloneByteArray(b);
	...
	/**
	 * Unit test for {@link Util#cloneByteArray(byte[], int)} length of clone is
	 * &lt; length of the original byte array.
	 */
	public final void testCloneByteArray2() {
		final byte b[] = new byte[] { 1, 2, 3, 4, 5, 6, -1 };
		final byte c[] = Util.cloneByteArray(b, 3);
	...
	/**
	 * Unit test for {@link Util#cloneByteArray(byte[], int)} - clone is longer
	 * than the original array.
	 */
	public final void testCloneByteArray3() {
		final byte b[] = new byte[] { 1, 2, 3, 4, 5, 6, -1 };
		final byte c[] = Util.cloneByteArray(b, 8);
	...
	public final void testBytesToLittleEndian() {
		final byte b1[] = new byte[] { 0, 1, 2, 3, 4, 5, 6, 7 };
		final byte b2[] = new byte[] { 3, 2, 1, 0, 7, 6, 5, 4 };
	...
	public void testMillisAndByteArray() {
		...
		} catch (final ArrayIndexOutOfBoundsException anEx) {
			// ok
		}
